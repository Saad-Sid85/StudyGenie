...
POPPLER_PATH = os.getenv(
    "POPPLER_PATH",
    r"C:\poppler-24.07.0\Library\bin"
)
...
def preprocess_image(image):
    ...
    # Remove unnecessary background variation
...
def extract_text_from_pdf(pdf_file):
    ...
    try:
        ...
        print(
            f"Normal PDF extraction failed: {e}"
        )
    ...
    try:
        ...
        for page_number, image in enumerate(
            ...
            #
            # This is better for normal scanned
            # lecture notes than forcing PSM 6.
            #
        ...
        raise Exception(
            ...
            "Please check Tesseract and Poppler installation. "
            f"Details: {str(e)}"
        )